...
This by no means is the only method to create the calculation, a finalisation Topic could also be created with the instructions within the Agent configuration however I find this simple method of appending the agent instructions a very easy method.
